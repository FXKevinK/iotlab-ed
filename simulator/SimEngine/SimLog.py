...
# === simulator
LOG_SIMULATOR_STATE = {u'type': u'simulator.state',
...
LOG_APP_RX = {u'type': u'app.rx',
              u'keys': [u'_mote_id', u'packet']}

# === secjoin
LOG_SECJOIN_TX = {u'type': u'secjoin.tx',
                  u'keys': [u'_mote_id']}
LOG_SECJOIN_RX = {u'type': u'secjoin.rx',
                  u'keys': [u'_mote_id']}
LOG_SECJOIN_JOINED = {u'type': u'secjoin.joined',
                      u'keys': [u'_mote_id']}
LOG_SECJOIN_UNJOINED = {
    u'type': u'secjoin.unjoined',          u'keys': [u'_mote_id']}
LOG_SECJOIN_FAILED = {u'type': u'secjoin.failed',
                      u'keys': [u'_mote_id']}

# === rpl
LOG_RPL_DIO_TX = {u'type': u'rpl.dio.tx',
                  u'keys': [u'_mote_id', u'packet']}
LOG_RPL_DIO_RX = {u'type': u'rpl.dio.rx',
                  u'keys': [u'_mote_id', u'packet']}
LOG_RPL_DAO_TX = {u'type': u'rpl.dao.tx',
                  u'keys': [u'_mote_id', u'packet']}
LOG_RPL_DAO_RX = {u'type': u'rpl.dao.rx',
                  u'keys': [u'_mote_id', u'packet']}
LOG_RPL_DIS_TX = {u'type': u'rpl.dis.tx',
                  u'keys': [u'_mote_id', u'packet']}
LOG_RPL_DIS_RX = {u'type': u'rpl.dis.rx',
                  u'keys': [u'_mote_id', u'packet']}
LOG_RPL_CHURN = {u'type': u'rpl.churn',
...
LOG_SIXLOWPAN_PKT_TX = {u'type': u'sixlowpan.pkt.tx',
                        u'keys': [u'_mote_id', u'packet']}
LOG_SIXLOWPAN_PKT_FWD = {u'type': u'sixlowpan.pkt.fwd',
                         u'keys': [u'_mote_id', u'packet']}
LOG_SIXLOWPAN_PKT_RX = {u'type': u'sixlowpan.pkt.rx',
                        u'keys': [u'_mote_id', u'packet']}
LOG_SIXLOWPAN_FRAG_GEN = {
    u'type': u'sixlowpan.frag.gen',        u'keys': [u'_mote_id', u'packet']}

# === MSF
LOG_MSF_TX_CELL_UTILIZATION = {u'type': u'msf.tx_cell_utilization',   u'keys': [
    u'_mote_id', u'neighbor', u'value']}
LOG_MSF_RX_CELL_UTILIZATION = {u'type': u'msf.rx_cell_utilization',   u'keys': [
    u'_mote_id', u'neighbor', u'value']}
LOG_MSF_ERROR_SCHEDULE_FULL = {
    u'type': u'msf.error.schedule_full',   u'keys': [u'_mote_id']}

# === sixp
LOG_SIXP_TX = {u'type': u'sixp.tx',
               u'keys': [u'_mote_id', u'packet']}
LOG_SIXP_RX = {u'type': u'sixp.rx',
               u'keys': [u'_mote_id', u'packet']}
LOG_SIXP_TRANSACTION_COMPLETED = {u'type': u'sixp.comp',
                                  u'keys': [u'_mote_id', u'peerMac', u'seqNum', u'cmd']}
LOG_SIXP_TRANSACTION_TIMEOUT = {u'type': u'sixp.timeout',              u'keys': [
    u'_mote_id', u'srcMac', u'dstMac', u'seqNum', u'cmd']}
LOG_SIXP_TRANSACTION_ABORTED = {u'type': u'sixp.abort',                u'keys': [
    u'_mote_id', u'srcMac', u'dstMac', u'seqNum', u'cmd']}

# === tsch
LOG_TSCH_SYNCED = {u'type': u'tsch.synced',
                   u'keys': [u'_mote_id']}
LOG_TSCH_DESYNCED = {u'type': u'tsch.desynced',
                     u'keys': [u'_mote_id']}
LOG_TSCH_EB_TX = {u'type': u'tsch.eb.tx',
                  u'keys': [u'_mote_id', u'packet']}
LOG_TSCH_EB_RX = {u'type': u'tsch.eb.rx',
                  u'keys': [u'_mote_id', u'packet']}
LOG_TSCH_ADD_CELL = {u'type': u'tsch.add_cell',             u'keys': [
    u'_mote_id', u'slotFrameHandle', u'slotOffset', u'channelOffset', u'neighbor', u'cellOptions']}
LOG_TSCH_DELETE_CELL = {u'type': u'tsch.delete_cell',          u'keys': [
    u'_mote_id', u'slotFrameHandle', u'slotOffset', u'channelOffset', u'neighbor', u'cellOptions']}
LOG_TSCH_TXDONE = {u'type': u'tsch.txdone',               u'keys': [
    u'_mote_id', u'channel', u'slot_offset', u'channel_offset', u'packet', u'isACKed']}
LOG_TSCH_RXDONE = {u'type': u'tsch.rxdone',               u'keys': [
    u'_mote_id', u'channel', u'slot_offset', u'channel_offset', u'packet']}
LOG_TSCH_BACKOFF_EXPONENT_UPDATED = {
    u'type': u'tsch.be.updated',           u'keys': [u'_mote_id', u'old_be', u'new_be']}
LOG_TSCH_ADD_SLOTFRAME = {u'type': u'tsch.add_slotframe',
...
LOG_RADIO_STATS = {u'type': u'radio.stats',               u'keys': [
    u'_mote_id', u'idle_listen', u'tx_data_rx_ack', u'tx_data', u'rx_data_tx_ack', u'rx_data', u'sleep']}
LOG_MAC_ADD_ADDR = {u'type': u'mac.add_addr',
                    u'keys': [u'_mote_id', u'type', u'addr']}
LOG_IPV6_ADD_ADDR = {u'type': u'ipv6.add_addr',
                     u'keys': [u'_mote_id', u'type', u'addr']}

# === propagation
LOG_PROP_TRANSMISSION = {u'type': u'prop.transmission',
                         u'keys': [u'channel', u'packet']}
LOG_PROP_INTERFERENCE = {u'type': u'prop.interference',         u'keys': [
    u'_mote_id', u'channel', u'lockon_transmission', u'interfering_transmissions']}
LOG_PROP_DROP_LOCKON = {u'type': u'prop.drop_lockon',         u'keys': [
    u'_mote_id', u'channel', u'lockon_transmission']}

# === connectivity matrix
LOG_CONN_MATRIX_K7_UPDATE = {u'type': u'conn.matrix.update',        u'keys': [
