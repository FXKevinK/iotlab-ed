...
class TypeComponent(OpenType):
    ...
    def update(self, type):
        ...
        elif type == self.COMPONENT_OPENTRICKLETIMERS:
            self.desc = 'OPENTRICKLETIMERS'

        elif type == self.COMPONENT_ICMPv6PERIODIC:
            self.desc = 'ICMPv6PERIODIC'
