...
#endif
#ifndef MAXKAPERIOD
#define MAXKAPERIOD               1500  // in slots: 1500@20ms per slot -> ~30 seconds. Max value used by adaptive synchronization.
#endif
...
#else
#define DESYNCTIMEOUT             2000
#endif

#define LIMITLARGETIMECORRECTION     30  // threshold number of ticks to declare a timeCorrection "large"
