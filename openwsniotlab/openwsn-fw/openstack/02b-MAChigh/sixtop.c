...
port_INLINE void sixtop_sendKA(void) {
    ...
    if (kaPkt == NULL) {
        LOG_ERROR(COMPONENT_SIXTOP, ERR_NO_FREE_PACKET_BUFFER, (errorparameter_t) 2, (errorparameter_t) 0);
        return;
    }
...
void sixtop_six2six_notifyReceive(
    ...
    if (type == SIXTOP_CELL_REQUEST) {
        ...
        if (response_pkt == NULL) {
            LOG_ERROR(COMPONENT_SIXTOP_RES, ERR_NO_FREE_PACKET_BUFFER, (errorparameter_t) 3, (errorparameter_t) 0);
            return;
        }
