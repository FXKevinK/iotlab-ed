        ...
        try:
            ...
            if event_sub_type == 'status':
                try:
                    ...
                    log.error("MOTECONNECTOR {}: received_status_notif doesn't exist".format(self.serialport))
                    
                except:
                    log.error("MOTECONNECTOR {}: Unexpected error {}".format(self.serialport, sys.exc_info()[0]))
