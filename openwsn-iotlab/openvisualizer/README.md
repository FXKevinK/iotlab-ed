...
For this version of openvisualizer, please use the companion repositories:

* [openwsn-fw](https://github.com/ftheoleyre/openwsn-fw): firmware that is run on the motes
